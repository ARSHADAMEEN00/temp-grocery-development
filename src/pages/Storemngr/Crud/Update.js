...
//actions
import { getStoremngrDetail, updateStoremngr } from "store/actions"
                      ...
                      <div className="row mb-4">
                        ...
                        <Col sm={9}>
                          <AvField
                            ...
                            name="first_name"
                            value={storemngrDetail?.first_name}
                            className="filePathClass"
                            type="text"
                            validate={{
                              required: { value: true },
                      ...
                      <div className="row mb-4">
                        ...
                        <Col sm={9}>
                          <AvField
                            ...
                            name="last_name"
                            value={storemngrDetail?.last_name}
                            type="text"
                            validate={{
                              required: { value: true },
                            }}
