...
export const getProductionmngrs = (searchText, page) => ({
...
export const createProductionmngr = (productionmngr, history) => ({
  type: CREATE_PRODUCTIONMNGR,
  payload: { productionmngr, history },
})

export const createProductionmngrSuccess = productionmngr => ({
