;(function ($) {
  ...
  var multiMarkColors = function () {
    if ($("#map-multi-marker-colors").length) {
      ...
      var markerIcon1 = L.divIcon({
        html: `<span className="svg-icon svg-icon-danger svg-icon-3x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="24" width="24" height="0"/><path d="M5,10.5 C5,6 8,3 12.5,3 C17,3 20,6.75 20,10.5 C20,12.8325623 17.8236613,16.03566 13.470984,20.1092932 C12.9154018,20.6292577 12.0585054,20.6508331 11.4774555,20.1594925 C7.15915182,16.5078313 5,13.2880005 5,10.5 Z M12.5,12 C13.8807119,12 15,10.8807119 15,9.5 C15,8.11928813 13.8807119,7 12.5,7 C11.1192881,7 10,8.11928813 10,9.5 C10,10.8807119 11.1192881,12 12.5,12 Z" fill="#7e46f0" fill-rule="nonzero"/></g></svg></span>`,
        bgPos: [10, 10],
        iconAnchor: [20, 37],
        popupAnchor: [0, -37],
      ...
      var markerIcon3 = L.divIcon({
        html: `<span className="svg-icon svg-icon-warning svg-icon-3x"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><rect x="0" y="24" width="24" height="0"/><path d="M5,10.5 C5,6 8,3 12.5,3 C17,3 20,6.75 20,10.5 C20,12.8325623 17.8236613,16.03566 13.470984,20.1092932 C12.9154018,20.6292577 12.0585054,20.6508331 11.4774555,20.1594925 C7.15915182,16.5078313 5,13.2880005 5,10.5 Z M12.5,12 C13.8807119,12 15,10.8807119 15,9.5 C15,8.11928813 13.8807119,7 12.5,7 C11.1192881,7 10,8.11928813 10,9.5 C10,10.8807119 11.1192881,12 12.5,12 Z" fill="#ff3551" fill-rule="nonzero"/></g></svg></span>`,
        bgPos: [10, 10],
        iconAnchor: [20, 37],
        popupAnchor: [0, -37],
        className: "leaflet-marker",
      ...
      var marker2 = L.marker([41.804, 13.843], { icon: markerIcon2 }).addTo(
        leaflet
      )
      var marker3 = L.marker([51.11, 10.371], { icon: markerIcon3 }).addTo(
        leaflet
      )
      var marker4 = L.marker([46.74, 2.417], { icon: markerIcon4 }).addTo(
        leaflet
      )
      ...
      leaflet.on("click", function (e) {
        geocodeService
          ...
          .run(function (error, result) {
            ...
            L.marker(result.latlng, { icon: markerIcon })
              .addTo(markerLayer)
  ...
  var MultiMark = function () {
    if ($("#map-multi-mark").length) {
      ...
      // init leaflet map
      var leaflet = new L.Map("map-multi-mark", {
        zoom: 10,
        center: new L.latLng(data[0].location),
      })
      ...
      data.forEach(function (item) {
        var marker = L.marker(item.location, { icon: leafletIcon }).addTo(
          leaflet
        )
